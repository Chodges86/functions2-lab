...
contains(names, "Caleb", result => {
  if(result === true){
    console.log('Caleb is in the array')
  } else {
    console.log('Caleb is not in the array')
  }
})
...
function uniq(arr, callback) {
  ...
  arr.forEach(value => uniqueSet.add(value))
...
function getUserById(arrOfObjects, id, callback) {
  callback(arrOfObjects.filter(object => object.id === id)[0])
}
